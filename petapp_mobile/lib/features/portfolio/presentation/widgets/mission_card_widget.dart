...
class MissionCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = mission.isComplete ? AppColors.positiveGreen : AppColors.neonCyan;
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(mission.title, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12)),
