...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget _buildActionButtons() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
      children: [
        Expanded(child: _buildGradientButton('Alimentar', 'Investir', Icons.pets, [const Color(0xFF8A2BE2), const Color(0xFFFF007F)])),
        const SizedBox(width: 12),
        Expanded(child: _buildGradientButton('Treinar', 'Analisar', Icons.menu_book, [const Color(0xFF8A2BE2), const Color(0xFFFF007F)])),
        const SizedBox(width: 12),
        Expanded(child: _buildGradientButton('Missões', 'Metas', Icons.flag, [const Color(0xFF8A2BE2), AppColors.neonCyan])),
      ],
    );
  }

  Widget _buildGradientButton(String title, String subtitle, IconData icon, List<Color> colors) {
    return Container(
